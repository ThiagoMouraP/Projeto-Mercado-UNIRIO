...
public class informacoesServico extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        info.add("Informações do seriço");
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position==4){
                    ...
                    intent.setData(Uri.parse("http://api.whatsapp.com/send?phone="+servico.getVendedor().getTelefone() +
                            "&text="+"Olá,me chamo "+Principal.retornaUsuario().getNome()+" e estou interessado no produto "+servico.getNome()));
                ...
                if(position==6){
                    ...
                    try {
                        servico.favoritar(Principal.retornaUsuario());
